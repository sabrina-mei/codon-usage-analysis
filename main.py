...
# PARAMETERS
sequence_file_name = ''     # name of the file containing your sequence(s) for analysis
output_folder_name = ''     # name of folder to save output graphs and files to
...
enc_gc3_title = ''          # title for the ENC vs GC3 graph
